function deviceHandle = BioRadio150_Load(pathToDllDirectory)
%----
%BIORADIO150_LOAD  Load BioRadio software interface
%
%   BIORADIO150_LOAD(pathToDllDirectory) loads the BioRadio
%   DLL to allow the calling of its library functions, and prepares
%   necessary data structures for use by those functions
%
%Example:
%   BioRadio150_Load('C:\CleveMed\BioRadio')
%
...
%----
    ...
    deviceHandle = calllib('BioRadio150DLL', 'CreateBioRadio');
