function BioRadio150_Test(pathToDllDirectory, pathToConfigFile, pathToFastDataOutputFile, pathToSlowDataOutputFile, NumChannelsToPlot)
%----
%BIORADIO150_TEST Example of acquiring and saving BioRadio data
%
%   BIORADIO150_TEST(pathToDllDirectory, pathToConfigFile, pathToOutputFile)
...
%----
    ...
    if (nargin ~= 5)
        error('Usage: BioRadio150_Test(<pathToDllDirectory>, <pathToConfigFile>, <pathToFastDataOutputFile>, <pathToSlowDataOutputFile>, <NumChannelsToPlot>)');
    end
