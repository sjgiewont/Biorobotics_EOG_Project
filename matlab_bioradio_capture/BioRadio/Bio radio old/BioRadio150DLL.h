...
extern "C" __declspec(dllimport) unsigned int _stdcall CreateBioRadio();
...
extern "C" __declspec(dllimport) long _stdcall GetMode(unsigned int BioRadio150, WORD &Mode);
extern "C" __declspec(dllimport) long _stdcall GetNumChannels(unsigned int BioRadio150);
extern "C" __declspec(dllimport) WORD _stdcall GetEnabledFastInputs(unsigned int BioRadio150);
...
extern "C" __declspec(dllimport) int _stdcall ReadRawData(unsigned int BioRadio150, WORD *Data, int Size, int *NumRead);
extern "C" __declspec(dllimport) int _stdcall ReadScaledFastAndSlowData(unsigned int BioRadio150, double *FastInputsData, int FastInputsSize, int *FastInputsNumRead, WORD *SlowInputsData, int SlowInputsSize, int *SlowInputsNumRead);
extern "C" __declspec(dllimport) int _stdcall ReadRawFastAndSlowData(unsigned int BioRadio150, WORD *FastInputsData, int FastInputsSize, int *FastInputsNumRead, WORD *SlowInputsData, int SlowInputsSize, int *SlowInputsNumRead);
extern "C" __declspec(dllimport) int _stdcall SetBadDataValues(unsigned int BioRadio150, double BadDataValueScaled, WORD BadDataValueRaw);
...
extern "C" __declspec(dllimport) int _stdcall GetDeviceID(unsigned int BioRadio150, WORD *DeviceID);
