function deviceHandle = BioRadio150_Load(pathToDllDirectory, useLegacyComputerUnit,num_devices)
%----
...
%----
    ...
    for i=1:num_devices
    deviceHandle(i) = calllib('BioRadio150DLL', 'CreateBioRadio', useLegacyComputerUnit);
